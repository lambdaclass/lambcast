defmodule LambcastWeb.LambcastComponents do
  ...
  ## Examples
    <.lambcast_user bio={@bio} picture={@picture} name={@name} user={@user}></.lambcast_user>
  """
  ...
  def lambcast_user(assigns) do
    ~H"""
    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div class="flex flex-col items-center px-4 py-10">
        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src={@picture} alt={@user} />
